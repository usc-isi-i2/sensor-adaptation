...
for idx_pair = 1:N_pair
    ...
    for idx_sensor = 1:6
        ...
        err_asc_align{idx_sensor, idx_pair} = adapt_asc_align(ref_sensor, rep_sensor, new_sensor, ground_truth);
    end
end

fprintf('Leveraging temporal and spatial info...\n');
...
for idx_sensor = 1:6
    ...
    fprintf('Sensor %g\t ASC: %.2f\t ASC-Align: %.2f\n', idx_sensor, mean(res_asc), mean(res_asc_align));
end