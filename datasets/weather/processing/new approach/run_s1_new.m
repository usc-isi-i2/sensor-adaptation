...
Y = train_y(3:GAP-2);
X = [train_y(1:GAP-4);train_y(2:GAP-3);train_y(4:GAP-1);train_y(5:GAP)];
...
label_val = w(5:end)'*X3;

Z3 = sq_feat([test_x(3:GAP2-2);test_z(3:GAP2-2)]);
Z1 = sq_feat([test_x(1:GAP2-4);test_z(1:GAP2-4)]);
Z2 = sq_feat([test_x(2:GAP2-3);test_z(2:GAP2-3)]);
Z4 = sq_feat([test_x(4:GAP2-1);test_z(4:GAP2-1)]);
Z5 = sq_feat([test_x(5:GAP2);test_z(5:GAP2)]);

new_X = Z3 - w(1)*Z1 - w(2)*Z2 - w(3)*Z4 - w(4)*Z5;
