function detect_changes_file(input_data_file, col_id, row_id)

% input_data_file is the path of input data (data matrix)
% col_id is the target sensor id
% row_id is when the training perid ends

input_data = dlmread(input_data_file);
