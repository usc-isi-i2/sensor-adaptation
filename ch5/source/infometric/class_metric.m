function class_metric(source, target, low_dim, lambda)
...
for tt = 1:T
    ...
    accu_semi_NN(tt) = fastknn(eye(low_dim), [lX;vaX], [lY;vaY], teX, teY, 1);
...
fname = ['result_infometric/', source, '_', target, '_D_', num2str(low_dim), '_L_', num2str(lambda), '_infometric.mat'];
save(fname, 'accu_NN', 'accu_semi_NN', 'accu_metric', 'accu_metric_semi_NN', 'metric_cell', 'dur');