function metric_LR_ICML(source, target, dim)
...
% if don't cheat
fname = ['/home/yuanshi/ICML12/infometric/result1/', source, '_', target, '_dim_', num2str(dim), '_reg_1_type_1_M.mat'];
load(fname);
...
for tt = 1:T
    ...
    curM = curM * dim;  % to make trace(curM) = dim
...
fname = ['result_metric_LR/', source, '_', target, '_D_', num2str(dim), '_metric_LR.mat'];
